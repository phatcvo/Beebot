...
public:
        ...
        rad2deg_(180.0 / M_PI)
    {
        ...
        posePub_ = nh_.advertise<geometry_msgs::PoseWithCovarianceStamped >(poseName_, 1);
    ...
    void publishROSMessages(void) {
        ...
        // Advertise PoseWithCovarianceStamped on the given topic
        geometry_msgs::PoseWithCovarianceStamped pose_with_covariance_msg;
        pose_with_covariance_msg.header = pose.header; 
        pose_with_covariance_msg.pose.pose = pose.pose;  
        pose_with_covariance_msg.pose.covariance.fill(0.0);         
        posePub_.publish(pose_with_covariance_msg);
