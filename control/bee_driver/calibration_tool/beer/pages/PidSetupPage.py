...
from beer.components.GraphFrame import GraphFrame
...
class PidSetupFrame(tb.Frame):
  def __init__(self, parentFrame, motorNo):
    ...
    self.label = tb.Label(self, text=f"MOTOR {g.motorLabel[self.motorNo]} PID SETUP", font=('Arial',16, 'bold') ,bootstyle="dark")
