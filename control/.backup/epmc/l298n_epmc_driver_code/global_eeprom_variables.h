...
int encA_clkPin = 2, encA_dirPin = 8; // encA_ppr parameter is decleared globally in the global_params_eeprom.h file.
...
int voltagePin = A0; 
int goPin = A1;
float R1 = 2000.0;  // 10kΩ
float R2 = 1000.0;   // 4.7kΩ
float scaleFactor = (R1 + R2 + 15) / R2;
// yaw pitch roll
float angles[3]; 
