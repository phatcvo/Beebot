...
from beer.pages.I2CSetupPage import I2CSetupFrame
...
class MainAppFrame(tb.Frame):
    def __init__(self, parentFrame):
        ...
        self.label = tb.Label(self.sideNavFrame, text="MENU", font=('Arial',20, 'bold') ,bootstyle="secondary")

        buttonStyle = tb.Style()
        buttonStyleName = 'primary.Link.TButton'
        buttonStyle.configure(buttonStyleName, font=('Arial',12, 'bold'))
        ...
        self.displayPage(self.button1, self.displayMotorAEncSetupPage)
        ############################################################
