...
from beer.components.SelectValueFrame import SelectValueFrame
from beer.components.MotorDrawFrame import MotorDrawFrame
from beer.components.CmdMotorFrame import CmdMotorFrame
...
class EncSetupFrame(tb.Frame):
  def __init__(self, parentFrame, motorNo):
    ...
    self.label = tb.Label(self, text=f"MOTOR {g.motorLabel[self.motorNo]} ENCODER SETUP", font=('Arial',16, 'bold') ,bootstyle="dark")
